            ...
            @if ($shopItems->isNotEmpty())
                <div class="bg-white dark:bg-gray-900 shadow-sm rounded-2xl p-8 ring-1 ring-gray-200 dark:ring-gray-700">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Ítems en venta</h2>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Props, ropa y accesorios de cosplay</p>
                        </div>
                        <a href="{{ route('shop.index', ['user_id' => $user->id]) }}"
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        @foreach ($shopItems as $item)
                            <a href="{{ route('shop.show', $item) }}"
                               class="group bg-gray-50 dark:bg-gray-800 rounded-xl ring-1 ring-gray-200 dark:ring-gray-700 overflow-hidden hover:ring-2 portfolio-primary-border hover:shadow-md transition">
                                ...
                                <div class="p-3">
                                    ...
                                    <p class="text-base font-bold portfolio-primary-text mt-1">
