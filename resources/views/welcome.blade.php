            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-bold text-gray-900">Fotógrafos & Cosplayers</span>
                    </a>
                </div>

                <div class="flex items-center gap-6">
                    <a href="{{ route('fotografos.index') }}" class="text-gray-700 hover:text-gray-900 font-medium">
                        Fotógrafos
                    </a>
                    <a href="{{ route('albumes.index') }}" class="text-gray-700 hover:text-gray-900 font-medium">
                        Álbumes
                    </a>
            ...
            <div class="text-center">
                ...
                <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('fotografos.index') }}"
                        class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white border-2 border-gray-300 text-gray-900 text-lg font-semibold rounded-lg hover:bg-gray-50 transition">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
                    <div class="text-center">
                        ...
                        <div class="mt-2 text-gray-600">Fotógrafos</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold text-purple-600">{{ $totalAlbums }}</div>
                        <div class="mt-2 text-gray-600">Álbumes Públicos</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold text-pink-600">∞</div>
                        <div class="mt-2 text-gray-600">Recuerdos</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if ($latestAlbums->isNotEmpty())
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900">Últimos Álbumes</h2>
                    <p class="mt-2 text-gray-600">Descubrí los eventos más recientes</p>
                </div>
                <a href="{{ route('albumes.index') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($latestAlbums as $album)
                    <a href="{{ route('albumes.show', $album) }}"
                        ...
                        <div class="p-5">
                            <h3 class="font-semibold text-gray-900 group-hover:text-indigo-600 mb-2 line-clamp-1">
                                {{ $album->title }}
                            </h3>
    ...
    <div class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-2 text-gray-600">Simple, rápido y gratis</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">1. Registrate</h3>
                    <p class="text-gray-600">Creá tu cuenta como fotógrafo o cosplayer en segundos</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">2. Subí Álbumes</h3>
                    <p class="text-gray-600">Compartí tus fotos usando Google Drive</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">3. Compartí</h3>
                    <p class="text-gray-600">Tu portfolio personalizado en una URL única</p>
                </div>
            </div>
        </div>
    </div>
