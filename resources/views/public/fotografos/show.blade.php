        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-900 shadow-sm rounded-2xl p-8 ring-1 ring-gray-200 dark:ring-gray-700">
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        @if ($user->photographerProfile?->location)
                        ...
                        <div class="flex flex-wrap gap-3 mt-6">
                            @if ($user->photographerProfile?->instagram)
                                <a href="https://instagram.com/{{ $user->photographerProfile->instagram }}"
                                    target="_blank" rel="noopener noreferrer"
                                    class="inline-flex items-center gap-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            @if ($user->photographerProfile?->portfolio_url)
                            ...
                            @if (!$user->photographerProfile?->instagram && !$user->photographerProfile?->portfolio_url)
            ...
            <div class="bg-white dark:bg-gray-900 shadow-sm rounded-2xl p-8 ring-1 ring-gray-200 dark:ring-gray-700">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Álbumes</h2>
                ...
                @if ($albums->isEmpty())
                    <div class="rounded-lg bg-gray-50 dark:bg-gray-800 p-8 ring-1 ring-gray-200 dark:ring-gray-700 text-center">
                        <svg class="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <p class="text-gray-700 dark:text-gray-300 font-medium">Este fotógrafo todavía no tiene álbumes públicos</p>
                ...
                @else
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach ($albums as $album)
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 overflow-hidden hover:shadow-md transition group">

                                {{-- Thumbnail --}}
                                <div class="aspect-video bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 flex items-center justify-center overflow-hidden">
                                    @if ($album->thumbnail)
                                ...
                                <div class="p-6">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition">
                                        {{ $album->title }}
                                    </h3>
                                    ...
                                    <div class="space-y-2 mt-4 text-sm text-gray-600 dark:text-gray-400">
                                        @if ($album->event_date)
            ...
            <div class="text-center">
                <a href="{{ route('fotografos.index') }}"
                    class="inline-flex items-center gap-2 text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
