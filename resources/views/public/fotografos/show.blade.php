                ...
                @else
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach ($albums as $album)
                            <div
                                class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden hover:shadow-md transition group">
                                ...
                                <div class="p-6">
                                    <h3
                                        class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-indigo-600 transition">
                                        {{ $album->title }}
                                    </h3>
